...
declare const DrawerRoot: import("vue").DefineComponent<import("vue").ExtractPropTypes<{
  ...
  'update:activeSnapPoint': (_snapPoint: number | string | null) => true;
  drag: (_event: PointerEvent, _percentageDragged: number) => true;
  release: (_event: PointerEvent | null, _open: boolean) => true;
  close: () => true;
  animationEnd: (_open: boolean) => true;
  snapProgress: (_progress: number, _isDragging: boolean) => true;
  ...
  onDrag?: ((_event: PointerEvent, _percentageDragged: number) => any) | undefined;
  "onUpdate:open"?: ((_open: boolean) => any) | undefined;
  "onUpdate:activeSnapPoint"?: ((_snapPoint: string | number | null) => any) | undefined;
  onRelease?: ((_event: PointerEvent | null, _open: boolean) => any) | undefined;
  onAnimationEnd?: ((_open: boolean) => any) | undefined;
  onSnapProgress?: ((_progress: number, _isDragging: boolean) => any) | undefined;
}>, {
  fixed: boolean;
  open: boolean;
  defaultOpen: boolean;
...
declare const TRANSITION_EASE: string;
//#endregion
export { DrawerClose, DrawerContent, type DrawerContext, DrawerDescription, type DrawerDirection, DrawerHandle, DrawerNestedRoot, DrawerOverlay, DrawerPortal, DrawerRoot, type DrawerRootProps, DrawerTitle, DrawerTrigger, Primitive, type SnapPoint, TRANSITIONS, TRANSITION_EASE, useDrawerContext };
